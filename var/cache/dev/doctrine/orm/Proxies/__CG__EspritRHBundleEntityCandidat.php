...
namespace Proxies\__CG__\Esprit\RHBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Candidat extends \Esprit\RHBundle\Entity\Candidat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Esprit\\RHBundle\\Entity\\Candidat' . "\0" . 'cin', '' . "\0" . 'Esprit\\RHBundle\\Entity\\Candidat' . "\0" . 'nom', '' . "\0" . 'Esprit\\RHBundle\\Entity\\Candidat' . "\0" . 'prenom', '' . "\0" . 'Esprit\\RHBundle\\Entity\\Candidat' . "\0" . 'experience', '' . "\0" . 'Esprit\\RHBundle\\Entity\\Candidat' . "\0" . 'specialite'];
        }
